...
public class PlaceRushScreenHandler extends BaseScreenHandler{
    /**
     * Logger
     */
    private static Logger LOGGER = Utils.getLogger(PlaceRushScreenHandler.class.getName());
    /**
     * Date formatter
     */
    ...
    public PlaceRushScreenHandler(Stage stage, String screenPath) throws IOException{
